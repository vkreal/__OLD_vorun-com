...
function SoundManager(smURL, smID) {
  ...
  this.useHighPerformance = false;   // position:fixed flash movie can help increase /a/js/flash speed, minimize lag
  ...
  this._externalInterfaceOK = function(flashDate, swfVersion) {
    ...
    // flashDate = approx. timing/delay info for /a/js/flash bridge
  ...
  _createMovie = function(smID, smURL) {
    ...
    swfTitle = '/a/js/Flash audio component (SoundManager 2)',
  ...
  _init = function() {
    ...
    try {
      ...
      _s._wD('/a/js/flash exception: ' + e.toString());
